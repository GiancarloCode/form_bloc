...
class _MockInputFieldBloc extends Mock implements InputFieldBloc<dynamic, dynamic> {}
...
void main() {
  group('FormBloc', () {
    ...
    test('when isLoading is true, onLoading is called after constructor initialization.', () async {
    ...
    group('submit', () {
      test('when autoValidate is true and step is invalid, call validate for each field bloc.',
          () async {
        final formBloc = _FormBlocImpl();
      ...
      test('when autoValidate is true and step is valid, not call validate for each field bloc.',
          () async {
        final formBloc = _FormBlocImpl();
      ...
      test('onSubmitting can add to state stream all states generated by to methods of state.',
          () async {
        final formBloc = _FormBlocImpl();
      ...
      test(
        ...
        // setup
        final fieldBlocs = <FieldBloc>[fieldBloc1, fieldBloc2, fieldBloc3, fieldBloc4];
