...
void main() {
  ...
  () => group(
        ...
        () {
          ...
          group('AddFieldBloc', () {
            test('check fieldBloc was added with valid formBloc state',
                () async {
            ...
            test('check updateFormBloc is called on fieldBloc', () async {
              ...
              verify(
                  () => fieldBloc.updateFormBloc(formBloc, autoValidate: true));
            });
          });
          ...
          test('FormBlocState is valid when all field blocs are valid.',
              () async {
            final formBloc = _FormBlocImpl();
