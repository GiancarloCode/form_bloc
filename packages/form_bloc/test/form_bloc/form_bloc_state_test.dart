...
void main() {
  group('FormBlocState:', () {
    test('Equality', () {
      final state1 = FormBlocLoaded<String, String>(isValidByStep: {1: true, 2: false});
      final state2 = FormBlocLoaded<String, String>(isValidByStep: {1: true});

      final state3 = FormBlocLoaded<String, String>(isValidByStep: {1: true, 2: false});
    ...
    test('to methods', () {
      final loadingState =
          FormBlocLoading<String, String>(isEditing: true, isValidByStep: {}, progress: 0.0);
      ...
      final deleteFailed = submissionCancelled.toDeleteFailed(failureResponse: 'fail');
      final deleteSuccessful = deleteFailed.toDeleteSuccessful(successResponse: 'success');
      ...
      final expectedStates = <FormBlocState>[
        ...
        FormBlocSubmitting<String, String>(
            isValidByStep: {}, isEditing: true, isCanceling: false, progress: 0.5),
        FormBlocSuccess<String, String>(
            isValidByStep: {}, isEditing: true, successResponse: 'success'),
        FormBlocFailure<String, String>(
            isValidByStep: {}, failureResponse: 'fail', isEditing: true),
        FormBlocSubmissionCancelled<String, String>(isValidByStep: {}, isEditing: true),
    ...
    group('hasSuccessResponse property:', () {
      test('FormBlocSuccess', () {
        final successWithResponse =
            FormBlocSuccess<Object, Object>(isValidByStep: {}, successResponse: 1);
        final successWithoutResponse = FormBlocSuccess<Object, Object>(isValidByStep: {});
      ...
      test('FormBlocDeleteSuccessful', () {
        final deleteSuccessfulWithResponse =
            FormBlocDeleteSuccessful<Object, Object>(isValidByStep: {}, successResponse: 1);
    ...
    group('hasFailureResponse property:', () {
      test('FormBlocLoadFailed', () {
        final loadedFailedWithResponse =
            FormBlocLoadFailed<Object, Object>(isValidByStep: {}, failureResponse: 1);
        final loadedFailedWithoutResponse = FormBlocLoadFailed<Object, Object>(isValidByStep: {});
      ...
      test('FormBlocFailure', () {
        final failureWithResponse =
            FormBlocFailure<Object, Object>(isValidByStep: {}, failureResponse: 1);
        final failureWithoutResponse = FormBlocFailure<Object, Object>(isValidByStep: {});
      ...
      test('FormBlocDeleteFailed', () {
        final deleteFailedWithResponse =
            FormBlocDeleteFailed<Object, Object>(isValidByStep: {}, failureResponse: 1);
        final deleteFailedWithoutResponse = FormBlocDeleteFailed<Object, Object>(isValidByStep: {});
